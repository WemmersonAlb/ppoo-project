...
public class Tarefa {
    ...
    public String toString() {
        String estado = "para fazer";
        if (estadoTarefa.equals(EstadoTarefa.ParaFazer))
            estado = "para fazer";

        if (estadoTarefa.equals(EstadoTarefa.Fazendo))
            estado = "fazendo";

        if (estadoTarefa.equals(EstadoTarefa.Completado))
            estado = "completado";

        return nome + "   Data: " + formatDate() + "  Estado: " + estado+ "   Prioridade: "+ prioridade;
    }
}
